      ...
      .config([
        '$routeProvider', '$routeSegmentProvider', ($r1, $r2) => {
          ...
          $routeProvider
            ...
            .when('/server-hosting', 'static_hosting')
            ...
            .segment('static_hosting', { controller: 'AureliaPageController' })
          ...
          global.segment('changelog', {
            ...
            resolve: setupQuery(GetChangelogQuery)
          });
          ...
          global.segment('premium', {
            ...
            .segment('form', {
              ...
              resolve: setupQuery(GetPremiumQuery),
            });
          ...
          global.segment('blog', {
            ...
            resolve: {
              model: setupQueryPart(GetBlogsQuery, { team: false }),
              postArchive: setupQueryPart(GetBlogArchiveSideQuery, { team: false }),
              recentPosts: setupQueryPart(GetBlogRecentQuery, { team: false })
            }
          })
            .segment('blog_team', {
              controller: 'BlogsController',
              templateUrl: '/src_legacy/app/main/blog/index.html',
              resolve: {
                model: setupQueryPart(GetBlogsQuery, { team: true }),
                postArchive: setupQueryPart(GetBlogArchiveSideQuery, { team: true }),
                recentPosts: setupQueryPart(GetBlogRecentQuery, { team: true })
              }
            })
            .segment('blog_archive', {
              ...
              resolve: {
                model: setupQueryPart(GetBlogArchiveQuery, { team: false }),
                postArchive: setupQueryPart(GetBlogArchiveSideQuery, { team: false }),
                recentPosts: setupQueryPart(GetBlogRecentQuery, { team: false })
              }
            })
            .segment('blog_team_archive', {
              ...
              templateUrl: '/src_legacy/app/main/blog/archive.html',
              resolve: {
                model: setupQueryPart(GetBlogArchiveQuery, { team: true }),
                postArchive: setupQueryPart(GetBlogArchiveSideQuery, { team: true }),
                recentPosts: setupQueryPart(GetBlogRecentQuery, { team: true })
              }
            });
          ...
          global
            .segment('blog_show', {
              ...
              resolve: {
                post: setupQueryPart(GetBlogQuery),
                postArchive: setupQueryPart(GetBlogArchiveSideQuery, { team: false }), // TODO: Hmmm.. Team...
                recentPosts: setupQueryPart(GetBlogRecentQuery, { team: false }) // TODO: Hmmm.. Team...
              }
            });
        }
      ]);
...
class DownloadStartController extends BaseController {
  ...
  private startDownload() {
    ...
    this.$scope.w6.navigate(this.$scope.url.api + '/downloads' + mini + '/latest2?type=' + final_type);
...
export class PremiumController extends BaseController {
  ...
  constructor(public $scope: IPremiumScope, public logger, $location: ng.ILocationService, private $window: ng.IWindowService, $q, private forwardService: ForwardService, model) {
    super($scope, logger, $q);
    ...
    $scope.openTermsDialog = () => $scope.request(OpenTermsDialogQuery);
    ...
    $scope.register = () => $scope.request(OpenRegisterDialogWithExistingDataQuery, { model: { email: $scope.model.email } });
