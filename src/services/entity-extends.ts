...
export module EntityExtends {
  ...
  export class User implements IUser {
    ...
    getAvatarUrl(size) { return this._avatars[size] || (this._avatars[size] = window.w6Cheat.url.calculateAvatarUrl(<any>this, size)); }

    clearAvatars() { this._avatars = {}; }

    get profileUrl() { return this._profileUrl || (this._profileUrl = this.slug ? window.w6Cheat.url.getUserSlugUrl(this.slug) : null); }
