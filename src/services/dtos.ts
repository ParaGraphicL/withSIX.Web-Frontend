...
export interface IBreezeContentPublisherInContent
  extends _IntDefs._ContentPublisherInContent { }
...
export module _InternalFakeCtors {
  ...
  export class ContentPublisherInContent { }
...
export class BreezeInitialzation {
  static registerEntityTypeCtors(store: breeze.MetadataStore) {
    ...
    store.registerEntityTypeCtor('ContentPublisherInContent', _InternalFakeCtors.ContentPublisherInContent);
...
export module BreezeEntityGraph {
  ...
  export class App {
    ...
    static publishers = (): ContentPublisherInContent => new ContentPublisherInContent("publishers");
    ...
    publishers = (): ContentPublisherInContent => new ContentPublisherInContent(this.$name + "." + "publishers");
  ...
  export class ContentPublisherInContent {
    static $name: string = "ContentPublisherInContent";
    $name: string = "ContentPublisherInContent";
    $type: string = "ContentPublisherInContent";

    constructor(name: string) {
      this.$name = name;
    }

    static createEntity(entityManager: breeze.EntityManager, config?: _IntDefs.__opt_ContentPublisherInContent): IBreezeContentPublisherInContent;
    ...
    public createEntity(entityManager: breeze.EntityManager, config?: _IntDefs.__opt_ContentPublisherInContent): IBreezeContentPublisherInContent;
  ...
  export class CollectionVersionDependency {
    ...
    static collectionDependency = (): Collection => new Collection("collectionDependency");
    ...
    collectionDependency = (): Collection => new Collection(this.$name + "." + "collectionDependency");
...
export module _IntDefs {
  ...
  export interface _App
    ...
    */
    ...
    /**(IBreezeContentPublisherInContent)
    */
    publishers: IBreezeContentPublisherInContent[];
  }
  ...
  export interface _ContentPublisherInContent
    extends breeze.Entity {
    //Data Properties
    /**(String)
    ...
    Validation:
     - required: "'Value' is required"
     - maxLength: "'Value' must be a string with 128 characters or less"
    */
  ...
  export interface __opt_ContentPublisherInContent {
    //Data Properties
    /**(String) [Key]
  ...
  export interface _CollectionVersionDependency
    ...
    */
    ...
    /**(Guid)
    [ForeignKey("collectionDependency")]

    Validation:
     - guid: "'Value' must be a GUID"
    */
    collectionDependencyId?: string; //Guid
    /**(Int64)
    ...
    */
    ...
    /**(IBreezeCollection)
    */
    collectionDependency: IBreezeCollection;
    /**(IBreezeCollectionVersion)
    */
